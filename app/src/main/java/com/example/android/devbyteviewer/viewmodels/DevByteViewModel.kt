...
class DevByteViewModel(application: Application) : AndroidViewModel(application) {
    ...
    /**
     * The repository determines which source (e.g., the network, database, etc.) the playlist is
     * retrieved from, keeping the implementation details out of the view model.
     */
